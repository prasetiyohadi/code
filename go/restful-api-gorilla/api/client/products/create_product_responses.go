...
func (o *CreateProductReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 502:
		result := NewCreateProductBadGateway()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateProductBadGateway creates a CreateProductBadGateway with default headers values
func NewCreateProductBadGateway() *CreateProductBadGateway {
	return &CreateProductBadGateway{}
}

/*CreateProductBadGateway handles this case with default header values.

Generic error message returned as a string
*/
type CreateProductBadGateway struct {
	Payload *models.GenericError
}

func (o *CreateProductBadGateway) Error() string {
	return fmt.Sprintf("[POST /products][%d] createProductBadGateway  %+v", 502, o.Payload)
}

func (o *CreateProductBadGateway) GetPayload() *models.GenericError {
	return o.Payload
}

func (o *CreateProductBadGateway) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
